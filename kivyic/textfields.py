...
class ICSimpleTextInput(TextInput, ThemableBehavior):
    ...
    def __init__(self, **kwargs):
        ...
        #                                halign='left',
        #                                valign='middle')
        super(ICSimpleTextInput, self).__init__(**kwargs)
...
class ICTextField(ThemableBehavior, FixedHintTextInput):
    helper_text = StringProperty("This field is required")
    helper_text_mode = OptionProperty('none', options=['none', 'on_error', 'persistent', 'on_focus'])
    ...
    def __init__(self, **kwargs):
        ...
        self._hint_lbl = TextfieldLabel(font_style='Subhead',
                                        halign='left',
                                        valign='middle')
        super(ICTextField, self).__init__(**kwargs)
        self.line_color_normal = self.theme_cls.divider_color
        self.line_color_focus = self.theme_cls.primary_color
        self.error_color = self.theme_cls.error_color
